-- ============================================================
-- KASINA HOTEL - HOTEL MANAGEMENT SYSTEM
...
CREATE TABLE IF NOT EXISTS room_reservations (
    ...
    status VARCHAR(30) NOT NULL DEFAULT 'confirmed', -- 'confirmed', 'checked_in', 'checked_out', 'cancelled', 'no_show'
...
CREATE TABLE IF NOT EXISTS room_payments (
    ...
    payment_method VARCHAR(50) NOT NULL, -- 'cash', 'card', 'telebirr', 'cbe_birr', 'bank_transfer', 'other'
    payment_type VARCHAR(50) NOT NULL DEFAULT 'payment', -- 'deposit', 'payment', 'refund'
...
SELECT 'Kasina Hotel database schema created successfully!' AS message;
